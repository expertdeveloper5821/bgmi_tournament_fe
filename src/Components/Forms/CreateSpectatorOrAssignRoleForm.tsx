...
export function CreateSpectatorOrAssignRoleForm({setModal,setFormErrors,setFormData,handleSubmit,modal,formData,handleChange,formErrors,roles,isDisabled}) {
