  ...
  useEffect(() => {
    if (updateVideoData) {
      ...
      setValues({
        ...
        time: `${String(dateAndTime.getHours()).padStart(2, '0')}:${String(
            ...
            <div className={styles.wrapper_background}>
              ...
              <form className={styles.main_div} onSubmit={handleSubmit}>
                <div className={styles.textArea}>
                  ...
                  <span className={styles.select_match_type}>
                    Select and upload a picture that shows what's in your video. Your thumbnail
                ...
                <div className={styles.video_section}>
                  <div className={styles.videos_copy}>
                    ...
                    {errors.videoLink && touched.videoLink && (
                      <div className={styles.error}>{errors.videoLink}</div>
                    )}
                    <div className={styles.datetime}>
                      <span className={styles.Uploadthumbnail}>Select Date/Time</span>
                      <span className={styles.select_match_type}>
                        Select date and time for publish your video
                      </span>
